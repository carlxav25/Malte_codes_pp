...
if year == 2013, num_month = 6; else num_month = 12; end
...
mast = load(['/Users/boy/Documents/Michael/sosa_in/Hyy/year/',YEAR,'/data_measured/mast_6m_new.txt']);
...
for mo = 1:num_month
   ...
   if mo == 2,  s = 1; if year == 2004 || year == 2008, k_end = 29; else k_end = 28, end, end
   ...
   for j = s:k_end
      if     year == 2003, DATE = 20030000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/03/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/03/';
      elseif year == 2004, DATE = 20040000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/04/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/04/';
      elseif year == 2005, DATE = 20050000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/05/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/05/';
      elseif year == 2006, DATE = 20060000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/06/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/06/';
      elseif year == 2007, DATE = 20070000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/07/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/07/';
      elseif year == 2008, DATE = 20080000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/08/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/08/';
      elseif year == 2009, DATE = 20090000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/09/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/09/';
      elseif year == 2010, DATE = 20100000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/10/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/10/';
      elseif year == 2011, DATE = 20110000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/11/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/11/'; 
      elseif year == 2012, DATE = 20120000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/12/'; filepath2 = 'c:\HY-data\BOY\documents\Hyyt/APS/11/'; 
      elseif year == 2013, DATE = 20130000 + j + mo*100; filepath  = '/Users/boy/Documents/Michael/Hyyt/Particle/13/'; filepath2 = '/Users/boy/Documents/Michael/Hyyt/APS/13/'; end
      date = [num2str(DATE)];
      month = eval(date(5:6));
      day   = eval(date(7:8));
      date1 = date(3:8);
      ...
      if exist(filename) == 2
         ...
         for i = 1:48
             ...
             cs_dL(i)     = sosa_cs_sa(dmps_diaL, dmps_numN(:,i), tem_mast(i,julian), 1);  
             %ch_dL(i)     = sosa_cs_sa(dmps_diaL, dmps_numN(:,i), tem_mast(i,julian), 1);
      ...
      if exist(filename2) == 2
         ...
         for i = 1:48
             ...
             cs_aL(i) = sosa_cs_sa(aps_diaNL, aps_numNN(:,i), tem_mast(i,julian), 1);  
...
if Savepar == 1
   ...
   elseif year == 2013, fid1 = fopen('/Users/boy/Documents/Michael/sosa_in/Hyy/year/2013/data_measured/cs_hyy.txt','w'); end
   ...
   elseif year == 2013, fid2 = fopen('/Users/boy/Documents/Michael/sosa_in/Hyy/year/2013/data_measured/cs_par.txt','w'); end
   for j = 1:length(cs_sum)
   ...
   elseif year == 2013, fid3 = fopen('/Users/boy/Documents/Michael/sosa_in/Hyy/year/2013/data_measured/coa_par.txt','w'); end
   for j = 1:length(cs_sum)
