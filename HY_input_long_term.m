...
%choose the date
% this version for set up a long-term input
clear;
clc;
close all
index_long_term=1;
adate='20130409'; %datenum = 99
...
input(:,14)=interp1(gas(a13,1),gas(a13,7),input(:,1),'linear')-input(:,13);
...
adate0=datestr(date-1,'mm/dd/yyyy HH:MM:SS');

dmps00=load(['/home/qiximeng/New_Malte_box_v2/Malte_in/Box/2013/2013/dm' adate0(9:10) adate0(1:2) adate0(4:5) '.sum']);
dmps10=load(['/home/qiximeng/New_Malte_box_v2/Malte_in/Box/2013/2013/dm' adate(3:end) '.sum']);
dmps0=[dmps00(:,:);dmps10(2:end,:)];
[m_d,n_d]=size(dmps0);
for j=2:1:n_d
    ddmps(:,1)=input(:,1);
...
if adate=='20130501'
dmps(2:43,2:end)=dmps(44:85,2:end);
else 
...
%...........................  
  r_input=[input(:,:);  input(end,:)];
  r_CS=[CS(:,:);CS(end,:)]; %last line is useless
  r_dmps=[dmps(:,:);dmps(end,:)];
  
  
  
%.................PLOT..............
figure(111)
plot(voc(:,1)-datenum(2013,1,1)+1,voc(:,13),'bo');
...
set(gca,'xlim',[input(1,1) input(1,1)+2]);
hold on
...
figure(7) %CH4
plot(gas(:,1),gas(:,end),'bo');


%...........save
%save(['/home/qiximeng/New_Malte_box_v2/Malte_in/Box/HY' adate(3:end) '/HY_input_v2.txt'],'r_input','-ascii');
%save(['/home/qiximeng/New_Malte_box_v2/Malte_in/Box/HY' adate(3:end) '/HY_input_cs_v2.txt'],'r_CS','-ascii');
%save(['/home/qiximeng/New_Malte_box_v2/Malte_in/Box/HY' adate(3:end) '/HY_input_dmps_v2.txt'],'r_dmps','-ascii');
