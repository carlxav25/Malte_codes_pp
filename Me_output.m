...
subplot(2,1,1);
pcolor(dmps_obs(:,1)'-1,dmps_obs(1,3:end)',log10(abs(dmps_obs(:,3:end)')+1e-6));
set(gca,'yscale','log');
set(gca,'xlim',[day day+2.])
set(gca,'ylim',[3e-9 1e-6]);
caxis([1,5]);
...
subplot(2,1,1);
P=plot(timew,num_simu(:,1),'r-');
set(P,'linewidth',2)
hold on
P=plot(dmps_obs(2:289,1)-1,num_obs(1:288,1),'b-');
set(P,'linewidth',2)
...
subplot(2,1,2)
P=plot(timew,vol_simu(:,1),'r-');
set(P,'linewidth',2)
hold on
P=plot(dmps_obs(2:289,1)-1,vol_obs(1:288,1),'b-');
set(P,'linewidth',2)
legend('Simulation','Observation');
set(gca,'Xlim',[day day+2]);
